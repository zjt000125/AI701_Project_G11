...
class CustomDatasetWithBG(Dataset):
    def __init__(
        ...
        # read the directory and get the image paths, exclude the mask images
        self.image_paths = []
    ...
    def __getitem__(self, i):
        example = {}
        # get the special character, in this case, it is 'S'
        placeholder_string = self.placeholder_token

        # put the special character into the template(a photo of a {})
        ...
        # get the embedding index of the text
        ...
        object_tensor = image_np * mask[:, :, None]
